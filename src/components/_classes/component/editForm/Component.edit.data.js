...
export default [
  ...
  },
  {
    ...
    tooltip: 'The Default Value (or enter the \'$\' character to use the values in the system) will be the value for this field, before user interaction. Having a default value will override the placeholder text.',
    input: true
  },
  {
    weight: 30,
